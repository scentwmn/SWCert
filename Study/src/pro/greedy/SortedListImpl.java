 ...
 * @param <T>
 */
public class SortedListImpl<T> extends ArrayList<T> {
	/**
	 ...
	 * @param comparator
	 */
	public SortedListImpl(Comparator<? super T> comparator) {
	 ...
	 * @param collection
	 */
	public SortedListImpl(Collection<? extends T> collection) {
		addAll(collection);
	}
	 ...
	 * @param comparator
	 */
	public SortedListImpl(Collection<? extends T> collection, Comparator<? super T> comparator) {
		this(comparator);
		addAll(collection);
	}
